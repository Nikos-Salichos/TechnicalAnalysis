...
namespace TechnicalAnalysis.Tests.IntegrationTests.ControllerTests
{
    public sealed class AnalysisControllerTest(IntegrationTestWebAppFactory factory) : BaseIntegrationTest(factory)
    {
        [Fact]
