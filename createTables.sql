...
COPY public."Assets" ("Id", "Symbol", "CreatedDate") FROM stdin;
3	TestContainersAsset	2023-11-02
\.


--
-- Data for Name: Candlesticks; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."Candlesticks" ("Id", pair_id, timeframe, open_date, close_date, open_price, high_price, low_price, close_price, volume, number_of_trades) FROM stdin;
\.


--
-- Data for Name: DexCandlesticks; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."DexCandlesticks" ("Id", "PoolContract", "PoolId", "OpenDate", "Open", "High", "Low", "Close", "Timeframe", "Fees", "Liquidity", "TotalValueLocked", "Volume", "TxCount") FROM stdin;
\.
...
COPY public."Pairs" (id, asset0_id, asset1_id, provider_id, symbol, is_active, all_candles, created_at) FROM stdin;
\.
...
COPY public."Pools" ("Id", "DexId", "PoolContract", "Token0Id", "Token0Contract", "Token1Id", "Token1Contract", "FeeTier", "Fees", "Liquidity", "TotalValueLocked", "Volume", "TxCount", "CreatedAt", "IsActive") FROM stdin;
\.


--
-- Data for Name: ProviderCandlestickSyncInfos; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."ProviderCandlestickSyncInfos" ("Id", "ProviderId", "TimeframeId", "LastCandlestickSync") FROM stdin;
\.


--
-- Data for Name: ProviderPairAssetSyncInfos; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."ProviderPairAssetSyncInfos" ("Id", "LastAssetSync", "LastPairSync", "ProviderId") FROM stdin;
\.
...
COPY public."Timeframes" ("Id", "Name") FROM stdin;
1	Daily
2	Weekly
3	OneHour
\.
