    ...
    public static class AdvancedIndicatorExtension
    {
        ...
        private static void CalculateCandlestickPatterns(PairExtended pair)
        {
            for (var i = 0; i < pair.Candlesticks.Count; i++)
            {
                var candlestick = pair.Candlesticks[i];
                var candlestick1 = i >= 1 ? pair.Candlesticks[i - 1] : null;
                var candlestick2 = i >= 2 ? pair.Candlesticks[i - 2] : null;
        ...
        private static bool GetLowestLowCondition(List<CandlestickExtended> candlesticks, int currentIndex)
        {
            ...
            var lowestLow1 = currentIndex >= 1 && currentIndex - 1 < candlesticks.Count ? candlesticks[currentIndex - 1].Lowests.Find(c => c is { PriceType: PriceType.Low, Period: 5 }) : null;
        ...
        private static bool GetHighestHighVixFix(List<CandlestickExtended> candlesticks, int currentIndex)
        {
            ...
            var highestHighVixFix1 = currentIndex >= 1 && currentIndex - 1 < candlesticks.Count
            ...
            var highestHighVixFix3 = currentIndex >= 3 && currentIndex - 3 < candlesticks.Count
                ? candlesticks[currentIndex - 3].Highests.Find(c => c is { PriceType: PriceType.VixFix, Period: 5 })
                : null;

            var highestHighVixFix4 = currentIndex >= 4 && currentIndex - 4 < candlesticks.Count
        ...
        private static bool GetOverboughtDonchianConditions(List<CandlestickExtended> candlesticks, int currentIndex)
        {
            ...
            return (candlesticks[currentIndex].HighPrice is not null && donchianChannel.UpperBand is not null && candlesticks[currentIndex].HighPrice >= (decimal)donchianChannel.UpperBand)
                || (candlesticks[currentIndex - 1].HighPrice is not null && donchianChannel1.UpperBand is not null && candlesticks[currentIndex - 1].HighPrice >= (decimal)donchianChannel1.UpperBand)
                || (candlesticks[currentIndex - 2].HighPrice is not null && donchianChannel2.UpperBand is not null && candlesticks[currentIndex - 2].HighPrice >= (decimal)donchianChannel2.UpperBand)
                || (candlesticks[currentIndex - 3].HighPrice is not null && donchianChannel3.UpperBand is not null && candlesticks[currentIndex - 3].HighPrice >= (decimal)donchianChannel3.UpperBand)
                || (candlesticks[currentIndex - 4].HighPrice is not null && donchianChannel4.UpperBand is not null && candlesticks[currentIndex - 4].HighPrice >= (decimal)donchianChannel4.UpperBand);
        }
